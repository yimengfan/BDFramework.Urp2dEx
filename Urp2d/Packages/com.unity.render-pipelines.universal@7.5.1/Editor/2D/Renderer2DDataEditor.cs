...
namespace UnityEditor.Experimental.Rendering.Universal
{
    ...
    internal class Renderer2DDataEditor : Editor
    {
        class Styles
        {
            ...
            public static readonly GUIContent RenderFeature             = EditorGUIUtility.TrTextContent("RenderFeature", "RenderFeature");
        }
        ...
        SerializedProperty RenderFeatures;
        ...
        void OnEnable()
        {
            ...
            for (int i = 0; i < numBlendStyles; ++i)
            {
                ...
                if (props.blendFactorMultiplicative == null) props.blendFactorMultiplicative = blendStyleProp.FindPropertyRelative("customBlendFactors.modulate");
                if (props.blendFactorAdditive       == null) props.blendFactorAdditive       = blendStyleProp.FindPropertyRelative("customBlendFactors.additve");
            }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_TransparencySortMode.intValue == (int) TransparencySortMode.CustomAxis) EditorGUILayout.PropertyField(m_TransparencySortAxis, Styles.transparencySortAxis);

            EditorGUILayout.PropertyField(m_HDREmulationScale, Styles.hdrEmulationScale);
            if (EditorGUI.EndChangeCheck() && m_HDREmulationScale.floatValue < 1.0f) m_HDREmulationScale.floatValue = 1.0f;
            ...
            //Render Feature
            EditorGUILayout.PropertyField(RenderFeatures,Styles.RenderFeature);
