...
namespace UnityEngine.Experimental.Rendering.Universal
{
    ...
    public class Renderer2DData : ScriptableRendererData
    {
        ...
        /// URP shaders
        /// </summary>
        public   ForwardRendererData.ShaderResources URPShaders;
        
        /// <summary>
        /// //Render Feature
        /// </summary>
        public List<RenderObjects.RenderObjectsSettings> RenderFeatures = new List<RenderObjects.RenderObjectsSettings>();
