...
namespace UnityEngine.Experimental.Rendering.Universal
{
    class Light2DManager : IDisposable
    {
        ...
        internal static Light2D GetGlobalLight(int sortingLayerIndex, int blendStyleIndex, out Color color)
        {
    ...
    sealed public partial class Light2D : MonoBehaviour
    {
        ...
        [SerializeField]
        Vector3 m_LightDirection = new Vector3(1,1,5);
        ...
        {
            get => this.m_IsMainLight;
            set => this.m_IsMainLight = value;
        }
